...
if (!class_exists('Blackhole_Bad_Bots')) {
	...
	final class Blackhole_Bad_Bots {
		...
		private function constants() {
			...
			if (!defined('BBB_VERSION')) define('BBB_VERSION', '2.8');
		...
		public static function default_uas() {
			...
			$uas  = 'a6-indexer, adsbot-google, ahrefsbot, aolbuild, apis-google, baidu, bingbot, bingpreview, butterfly, cloudflare, duckduckgo, embedly, ';
			...
			$uas .= 'uptimerobot, urlresolver, vkshare, w3c_validator, wordpress, wprocketbot, yandex';
