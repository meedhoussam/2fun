...
.vce-single .entry-headline p{
    font-size: <?php echo $font_size_entry_text; ?>rem;
}
.main-navigation a{
...
.vce-featured-link-article{
    font-size: <?php echo $font_size_fa_big?>rem;
}
.vce-featured-grid-big.vce-featured-grid .vce-featured-link-article{
    font-size: <?php echo $font_size_fa_medium?>rem;
}
.vce-featured-grid .vce-featured-link-article{
    font-size: <?php echo $font_size_fa_small?>rem;
}

h1 { font-size: <?php echo $font_size_single_title; ?>rem; }
h2 { font-size: <?php echo $font_size_h2; ?>rem; }
h3 { font-size: <?php echo $font_size_h3; ?>rem; }
h4 { font-size: <?php echo $font_size_h4; ?>rem; }
h5 { font-size: <?php echo $font_size_h5; ?>rem; }
h6 { font-size: <?php echo $font_size_h6; ?>rem; }
...
h1.entry-title{
    font-size: <?php echo $font_size_single_title; ?>rem;
}

.vce-lay-a .entry-title a{
    font-size: <?php echo $font_size_layout_a; ?>rem;
}

.vce-lay-b .entry-title{
    font-size: <?php echo $font_size_layout_b; ?>rem;
}

.vce-lay-c .entry-title, .vce-sid-none .vce-lay-c .entry-title{
    font-size: <?php echo $font_size_layout_c; ?>rem;
}

.vce-lay-d .entry-title{
    font-size: <?php echo $font_size_layout_d; ?>rem;
}

.vce-lay-e .entry-title{
    font-size: <?php echo $font_size_layout_e; ?>rem;
}

.vce-lay-f .entry-title{
    font-size: <?php echo $font_size_layout_f; ?>rem;
}

.vce-lay-g .entry-title a, .vce-lay-g .entry-title a:hover{
    font-size: <?php echo $font_size_layout_g; ?>rem;
}

.vce-lay-h .entry-title{
    font-size: <?php echo $font_size_layout_h; ?>rem;
}
